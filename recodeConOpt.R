...
# Open PM norms db
# Skip first 3 rows
data <- read.xlsx("data//Concept Optimizer Norms Database with Star Calculator.xlsx", sheet = 3, startRow = 2, colNames = TRUE,
                  skipEmptyRows = TRUE)
...
# Save CSV file
write.csv(data, file = "recoded/conOptMojo.csv", na = "", row.names = FALSE, fileEncoding = "UTF-8")
