##
# Recode values in excel file from old product categories to new MOJO categories
# Concept Testing file does not have MOJO column so adds new column to end
# Assumes:
...
# Open PM norms db
# Skip first 3 rows
data <- read.xlsx("data//Concept Testing Norms Database with Star Calculator.xlsx", sheet = 3, startRow = 2, colNames = TRUE,
                  skipEmptyRows = TRUE)
...
# Save CSV file
write.csv(data, file = "recoded/conTestMojo.csv", na = "", row.names = FALSE, fileEncoding = "UTF-8")
