...
# Open PM norms db
# Skip first 3 rows
data <- read.xlsx("data//ComMotion Norms Database with Star Calculator.xlsx", sheet = 5, startRow = 2, colNames = TRUE,
                  skipEmptyRows = TRUE)
...
# Save CSV file
write.csv(data, file = "recoded/comMojo.csv", na = "", row.names = FALSE, fileEncoding = "UTF-8")
